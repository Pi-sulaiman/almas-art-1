...
// import myGif from  '../public/12.gif'
const city = import('./b.exr').then((module) => module.default)
...
function Frame({ url, c = new THREE.Color(), ...props }) {
  ...
  useFrame((state, dt) => {
    ...
    easing.dampC(frame.current.material.color, hovered ? '#00ff00' : 'white', 0.1, dt)
  })
  return (
    <group {...props}>
      <mesh
